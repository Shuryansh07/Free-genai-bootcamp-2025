...
<scoring-criteria>
    <category name="vocabulary-table">
        <criteria>
            <criterion>Contains all necessary words (2 points)</criterion>
            <criterion>Correct formatting (2 points)</criterion>
            <criterion>Dictionary forms only (2 points)</criterion>
            <criterion>No particle inclusion (2 points)</criterion>
            <criterion>Appropriate difficulty level (2 points)</criterion>
        </criteria>
    </category>
    <category name="sentence-structure">
        <criteria>
            <criterion>Clear bracketed format (2 points)</criterion>
            <criterion>No conjugations shown (2 points)</criterion>
            <criterion>Appropriate for level (2 points)</criterion>
            <criterion>Matches example patterns (2 points)</criterion>
            <criterion>No particles included (2 points)</criterion>
        </criteria>
    </category>
</scoring-criteria>
...
<version-control>
    <version number="1.0">
        <changes>
            <change>Initial test documentation</change>
            <change>Basic test cases added</change>
            <change>State transition examples</change>
        </changes>
        <date>2025-01-03</date>
    </version>
    <planned-improvements>
        <improvement>Add more complex sentence patterns</improvement>
        <improvement>Expand vocabulary edge cases</improvement>
        <improvement>Include cultural context tests</improvement>
        <improvement>Add error recovery scenarios</improvement>
    </planned-improvements>
</version-control>
